...
$config['LicenseName'] = 'hieudev';
$config['LicenseKey'] = '18P8PCRX9B313AR7FCSSED737MRM9';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = 'd:/xampp/htdocs/PHP/PHP151219/ShopQuanAo/public/backend/data/'; //resolveUrl($baseUrl);
