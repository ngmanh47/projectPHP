...
<div class="super_container">
	...
	<header class="header trans_300">
		...
		@include('frontend.widgets.topNav')

		<!-- Main Navigation -->

		@include('frontend.widgets.mainNav')
	</header>
	...
	@include('frontend.products.newArrivals')
			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="deal_ofthe_week_img">
						<img src="{{asset('frontend/images/deal_ofthe_week.png')}}" >
					</div>
				</div>
	...
	@include('frontend.products.bestSeller')
	</form>
