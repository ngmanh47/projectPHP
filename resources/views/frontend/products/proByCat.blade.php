...
<link rel="stylesheet" type="text/css" href="{{asset('/public/frontend/styles/categories_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('/public/frontend/styles/categories_responsive.css')}}">
@endsection
                                ...
                                <div class="product-item men">
                                    <div class="product discount product_filter">
                                        ...
                                        <div class="product_info">
                                            ...
                                            <div class="product_price">{{$item->unitprice}}<span>{{$item->unitprice}}</span></div>
                                        </div>
                                    </div>
...
<script src="{{asset('/public/frontend/js/categories_custom.js')}}"></script>
@endsection